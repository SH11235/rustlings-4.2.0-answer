...
// 3. Make `fill_vec` *mutably* borrow its argument (which will need to be mutable),
// modify it directly, then not return anything. Then you can get rid of `vec1` entirely
